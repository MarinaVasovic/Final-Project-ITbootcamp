...
public class TekstZadatka {
	 ...
	 * Zavrsni projekat pise se u programskom jeziku java koristeci selenium,
	 * postujuci POM (page object model). Testovi se pisu samo za “happy path”
	 * (pozitivne scenarije) koristeci testNG. Radi se 4 dana, za vreme predavanja.
	 ...
	 * 
	 * Kao pripremu za izradu projekta potrebno je napraviti lazni nalog na tom
	 * sajtu i zapoceti besplatnu probnu verziju.
	 * 
	 * 
	 * Ne ostavljati prave e-mail adrese. Kredencijale izmisliti ili koristiti neki
	 * sajt za generisanje i sacuvati kredencijale negde radi kasnijeg koriscenja.
	 * 
	 * ZADACI:
	 * 
	 * a) pocetna strana
